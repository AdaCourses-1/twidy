...
const Chat = () => {
  ...
  return (
    <div className="rounded-md overflow-hidden pb-10 w-full">
      <div className="flex">
        <Chats />
        <div
        ...
        >
          ...
          <div className="flex pt-5 items-end gap-7 mt-auto fixed bottom-0 left-[50%] -translate-x-1/2 w-full bg-white px-14 pb-8">
